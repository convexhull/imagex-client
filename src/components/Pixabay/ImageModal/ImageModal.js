                ...
                <div className={classes["image-header"]}>
                    ...
                    <div className={classes["actions"]}>
                        ...
                        <div className={classes["download-button"]}>
                            <a title="Download photo" href={this.props.image.largeImageURL}  rel="noopener noreferrer" target="_blank"  ><span className="_2Aga-"><i class="fa fa-download" aria-hidden="true"></i></span></a>
                        </div>
                    </div>  
                </div>
